...
ref. "How to improve RAG peformance — Advanced RAG Patterns — Part2"
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://cloudatlas.me/how-to-improve-rag-peformance-advanced-rag-patterns-part2-0c84e2df66e6"

# ╔═╡ 797e6deb-e014-4609-b0d4-7f3ec670cb1c
const TOPIC = " improving RAG performance"

# ╔═╡ 2f4ae40f-a1ab-470b-a1b7-a04fec353b0e
const INSTRUCT_PROMPT = """Generate a comprehensive and detailed synthesis of the following excerpt (delimited by triple backticks) about $(TOPIC). Please report all the problems identified and their principle solution. As always, extract all the code snipets (if present). Here is the excerpt:""";
