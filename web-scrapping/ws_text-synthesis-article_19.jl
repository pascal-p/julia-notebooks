...
ref. "Advanced RAG Implementation on Custom Data Using Hybrid Search, Embed Caching And Mistral-AI"
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://medium.aiplanet.com/advanced-rag-implementation-on-custom-data-using-hybrid-search-embed-caching-and-mistral-ai-ce78fdae4ef6"

# ╔═╡ 797e6deb-e014-4609-b0d4-7f3ec670cb1c
const TOPIC = "Advanced RAG with Hybrid Search"

# ╔═╡ 2f4ae40f-a1ab-470b-a1b7-a04fec353b0e
const INSTRUCT_PROMPT = """Generate a comprehensive and detailed synthesis of the following excerpt (delimited by triple backticks) about $(TOPIC). Please extract all the code snipets but those where 'query', 'response' and 'OUTPUT' are displayed, with indentation of 2 spaces. You can ignore the web links for the references as these will be added later on. Here is the excerpt:""";
