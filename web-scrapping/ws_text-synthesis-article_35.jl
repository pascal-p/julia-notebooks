...
ref. "Inside DSPy: The New Language Model Programming Framework You Need to Know About"
main site: towards.ai
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://towardsai.net/p/machine-learning/inside-dspy-the-new-language-model-programming-framework-you-need-to-know-about"

# ╔═╡ 797e6deb-e014-4609-b0d4-7f3ec670cb1c
const TOPIC = "DSPy and structured prompting"

# ╔═╡ c27b4042-8bb2-435f-8275-ac07f3ae99c8
...
# ╔═╡ 240df418-426c-48bb-b28f-bfc16dd392b6
parsed_doc |> propertynames
...
# ╔═╡ bcab75f3-6d9e-4cf4-b910-a4a609d7cd6a
parsed_doc.root[2].children  # finding the right root /1

# ╔═╡ c45c82b4-2602-44fe-a6cc-557cd69ebc91
parsed_doc.root[2].children[2].children[1].children  # finding the right root /2

# ╔═╡ 78389e7c-e6a5-4bd2-9274-d1a2c68a4920
rroot = parsed_doc.root[2].children[2].children[1].children[7].children[1].children[1];  # towards.ai
# parsed_doc.root[2].children[1].children[1];  # medium root

# ╔═╡ 8fdfb225-1475-483e-a81a-5a450b5b0dbd
traverse_article_structure(rroot; selector="div.entry-header")

# ╔═╡ ec78f105-6204-422d-b01f-912ba4f07e70
traverse_article_structure(rroot; selector="div.page-main-content")

# ╔═╡ 67fd72dc-5540-440d-a8f3-8324914553b8
# formatting relevant to towardsia.net type articles
text = extract_content(
	rroot;
	selectors=["div.new-articles-11-21"],  # selectors=["p.pw-post-body-paragraph"],
	verbose=true,
	only_tags=[:div, :p, :h1, :h2, :h3, :li, :ul, :ol, :span, :pre]  # include :pre for code snipet
)

# ╔═╡ 4d595c16-8e53-421e-84e5-00d58d20cd1c
# println(text)
...
links = extract_links(
	...
	selectors=["a"], 
	verbose=false, 
	restrict_to=["github", "LinkedIn", "huggingface", "arxiv", "towardsai.net", "edu", "llamaindex", "langchain", "wikipedia", "cohere", "dspy"],
	excluding_regex=r"signin\?|(?:sponsors|newsletter)\.towardsai|towardsai\.net/(?:ai|wp-admin)|towardsai\.net/(?:p/)?(?:subscribe|data-science|news|tag|machine-learning|statistics|author)"i, 
	# towardsai\.net/p/(?:data-science|news|tag|machine-learning)/|
	# towardsai\.net/(?:[^/]+/)?(?:subscribe|followers|towards-ai|statistics
)
