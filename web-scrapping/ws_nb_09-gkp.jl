...
On Generate Knowledge Prompting. 
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://www.promptingguide.ai/techniques/knowledge"
...
rroot = parsed_doc.root[2].children[1].children[2].children[3].children[5];
...
text = extract_llm_settings(rroot; selector="main.nx-w-full")
