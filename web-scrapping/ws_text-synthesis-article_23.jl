...
ref. "Deconstructing RAG"
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://blog.langchain.dev/deconstructing-rag"
...
@time req = HTTP.get(URL, response_stream=IOBuffer(), redirect=true, detect_content_type=true, verbose=2)

# ╔═╡ 67f54eb2-d985-4a57-a3f4-0d10ae033104
propertynames(req)

# ╔═╡ 4c25bfae-6f3f-4389-b4bf-adc706e64bc8
req.status, req.request

# ╔═╡ ae1c18f8-f63f-449d-9ab7-a1531eb87848
body = String(take!(req.body))

# ╔═╡ 2402d947-3e04-4495-9e92-1f59b171dcc8
parsed_doc = Gumbo.parsehtml(
...
# ╔═╡ f155c919-7e02-4978-bfff-0354677702c0
parsed_doc.root[2].children # a, div, script

# ╔═╡ dfcaa25d-2750-458a-a101-577677cde994
parsed_doc.root[2].children[2].children[2].children[1].children

# ╔═╡ 78389e7c-e6a5-4bd2-9274-d1a2c68a4920
rroot = parsed_doc.root[2].children[2].children[2] # .children[1]

# ╔═╡ 8fdfb225-1475-483e-a81a-5a450b5b0dbd
traverse_article_structure(rroot, selector=".article-main")
...
md_title = extract_content(rroot; selectors=[".article-header__title"], verbose=false)  # Title

# ╔═╡ 72d4f892-2bd2-43af-b71e-5252a666ce0c
md = extract_content(rroot; selectors=[".article-header"], verbose=false)  # other metadata

# ╔═╡ b775bbc9-beb5-4269-9816-f483108e7317
print(md)

# ╔═╡ 67fd72dc-5540-440d-a8f3-8324914553b8
text = extract_content(
	rroot; 
	selectors=[".article-content"],  # "pre.ba.bj": for code snipet
	detect_code=true,
	verbose=false
)
