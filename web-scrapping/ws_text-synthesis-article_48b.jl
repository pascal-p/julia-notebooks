...
ref. "Graph-driven RAG: Approaches Compared (Part 3)"
"""

# ╔═╡ f4c27df9-bbc1-4498-b7a0-42da0d049199
const URL = "https://ryanoattes.medium.com/graph-driven-rag-approaches-compared-fcd31d9a4ee6"

# ╔═╡ 797e6deb-e014-4609-b0d4-7f3ec670cb1c
const TOPIC = """Graph RAG"""

# ╔═╡ a1fd69e5-4d30-4bdc-ab31-8bf0c46ff938
...
const INSTRUCT_PROMPT = """Generate a comprehensive and detailed section by section synthesis of the following article (delimited by triple backticks) about "$(TOPIC)". Adopt third person point of view.
...
- Render the python code sections as they appear in the original article, apply indent of 2 and separate top import from rest of the code with one blank line.
...
!isfile(MD_FILEPATH) && (save_text(TXT_FILEPATH, full_text₁))
...
begin
        ...
        if length(links) == 0
                regex = r"(?<=Links:\s)(.*)"s
                matched = match(regex, text_for_synthesis)
