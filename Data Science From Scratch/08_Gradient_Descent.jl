...
begin
	...
	data = [[x, 10x + 5. + 50. * randn(rng, 1)[1]] for x ∈ -50.:50.]
end
...
begin
	slope, intercept = ∇_descent(data)  # 9.93698, -1.0823
	@test 9.90 ≤ slope ≤ 9.94
	@test -1.1 ≤ intercept ≤ -1.0
end
...
# ╔═╡ d21591fa-8893-11eb-33ad-13ec4aa694e0
9.93698
